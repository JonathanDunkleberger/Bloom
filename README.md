...
<p align="center">
  <a href="docs/architecture.html">
    <img src="docs/architecture-preview.png" alt="System Architecture" width="100%" />
  </a>
  <br />
...
│   ├── quitDate: ISO string (quit only)
│   ├── dailyCost: number (quit only)
│   ├── reason: string
│   ├── paused: boolean
│   └── creature: { stage: 0-4, color: string }
│
